...
body{height:100%;min-height:700px;width:100%;position:absolute} 
...
body{height:100%;min-height:1280px} 
...
int ET =0;
int End;
int[] sum = {AA,BB,DD,CC,EE,AA,CC,BB,EE,DD,AA};
 for(i=0;i<10;i++){
     a=i+1;
if(sum[i]==sum[a]){
   if(AA==sum[i]){
...
<h1 class="font">
我是玳瑁，玳瑁本身就有寶石的意思<BR>暢游在海洋裡，讓龜甲反射海藍色變的BLING  BLING，是我的愛好！除了特色龜甲，還有可愛的鷹嘴，平常喜歡吃海草，而且我還是唯一可以吃海綿、消化『玻璃』的海龜！
</h1>
</div>
...
else if(Answer=="BB"||"BB".equals(Answer)){
%>
<div id="Turtle" style="position:absolute;">
...
<h1 class="font">
久經沙場，在人際交往之間的舉手投足都能平衡掌握的你，在外人看來也許你冷靜且睿智，是能幫很多人解決困難的大神，但心中一定有許多沉澱在心中後悔的回憶，過去就讓它過去吧，是時候了，偶爾也該思索一下自己的未來，偉大航道在等著你。
</h1>
</div>
<div id="TurtleT2" style="background-color:#8F8C85;position:absolute">
<h1 class="font">
我是革龜，我可是體型最大的海龜！<BR>我的頭頂上會有屬於我的獨特粉紅斑點，我一天要吃好多好多的水母，因為我要累積能量才能一直一直在大海中洄游，絕對不是因為我貪吃啦！
</h1>
</div>
<div id="TurtleT0" style="background-color:#97ceec;position:absolute">
...
else if(Answer=="CC"||"CC".equals(Answer)){
%>
<div id="Turtle" style="position:absolute;">
...
<h1 class="font">
我是橄欖龜，我最喜歡吃肉！<BR>魚類、甲殼類、軟體動物都是我的最愛～我雖然體型小，但我可是勇敢的海龜，我們會集體上岸產卵，很特別吧！
</h1>
</div>
<div id="TurtleT0" style="background-color:#97ceec;position:absolute">
...
else if(Answer=="DD"||"DD".equals(Answer)){
%>
<div id="Turtle" style="position:absolute;">
...
<h1 class="font">
我是綠蠵龜<BR>喜歡捕食易取得、不會逃跑的食物（例如：海草），綠色素的累積因而讓我的外表呈現綠色，我也是唯一會上岸曬太陽的海龜，臉部看起來有點傻傻、呆呆的，是海洋世界的萬人迷喔！
</h1>
</div>
<div id="TurtleT0" style="background-color:#97ceec;position:absolute">
...
else if(Answer=="EE"||"EE".equals(Answer)){
%>
<div id="Turtle" style="position:absolute;">
...
<h1 class="font">
我最紅！我是赤蠵龜，龜紅是非多<BR>我也被人叫做大頭龜，但我可沒有大頭症！平常吃吃甲殼類和軟體動物悠悠自在~對了！我最喜歡夕陽落下的魔幻時刻，就像我的鱗片一樣橘橘黃黃的。
</h1>
</div>
<div id="TurtleT0" style="background-color:#97ceec;position:absolute">
...
%>
<div id="TurtleT3" style="background-color:#97ceec;position:absolute">
<a class="buttonT" target="_blank" style="border-radius:25px;background-color:#cfe2ec;position:absolute;bottom:10%;right:5%;height:80%;width:42.5%;align-items:center;text-align:center;display:grid;text-decoration:none" href="Alogin.jsp">會員存取</a>
<a class="buttonT" target="_blank" style="border-radius:25px;background-color:#5eb3e1;position:absolute;bottom:10%;left:5%;height:80%;width:42.5%;align-items:center;text-align:center;display:grid;text-decoration:none" href="frontpage.jsp">返回首頁</a>
</div>
</body>