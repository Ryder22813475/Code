...
<html>
    <body style="background-color:white"><!--整體-->
      ...
      <h1 id="L2" class="link" style="height: 100%; position: relative; right: -65%; top: -110%; margin-left: 10%; width: 150%; color: white;" onclick="location.href='caTestManagement.jsp'">測驗管理</h1></div>
